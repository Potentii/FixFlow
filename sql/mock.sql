...
insert into `ticket` (`title`, `urgency`, `description`, `status`, `date_closed`, `category_fk`, `client_fk`) values ('Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi.', 'HIGH', 'Vivamus tortor.', 'PENDING', null, 5, 8);
...
insert into `ticket` (`title`, `urgency`, `description`, `status`, `date_closed`, `category_fk`, `client_fk`) values ('Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante.', 'HIGH', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 'PENDING', null, 6, 4);
...
insert into `ticket` (`title`, `urgency`, `description`, `status`, `date_closed`, `category_fk`, `client_fk`) values ('Suspendisse potenti.', 'HIGH', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus.', 'PENDING', null, 4, 13);
